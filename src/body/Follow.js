...
const Follow = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch('https://surge-backe.vercel.app/following', {
        method: 'GET',
        headers: {
  ...
  const handleLike = async (postId) => {
    try {
      ...
      const response = await fetch(`https://surge-backe.vercel.app/like/${postId}`, {
        method: 'POST',
        headers: {
  ...
  const handleComment = async (postId) => {
    try {
      ...
      const response = await fetch(`https://surge-backe.vercel.app/comment/${postId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${jwtToken}`,
  ...
  const handledelete = async (userid) =>{
    try{
      ...
      const response = await fetch(`https://surge-backe.vercel.app/delete/${userid}`, {
        method: 'get',
        headers: {
          'Content-Type': 'application/json',
          Authorization: ` ${jwtToken}`,
